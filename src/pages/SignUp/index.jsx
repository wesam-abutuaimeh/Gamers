        ...
        <div className="sign__up__container">
            ...
            <div className="right__side">
                ...
                <div className="registration__area">
                    ...
                    <form action="#">
                        <InputField htmlFor="username" title="Username*" type="text"
                            placeholder="Enter username" required={true}
                            id="username" className="username" onChange={handleChangePassword} />

                        <InputField htmlFor="email" title="Email Address*" type="email"
                            placeholder="Enter email address" required={true}
                            id="email" className="email" />

                        <InputField htmlFor="phone__number" title="Phone Number*" type="number"
                            placeholder="Enter phone number" required={true}
                            id="phone__number" className="phone__number" />

                        <div className="password">
                            <InputField htmlFor="create__password" title="Create Password*" type="password" placeholder="password" required={true}
                                id="create__password" className="create__password"
                                handlePassword={handleChangePassword} />

                            <div>
                                <div className="process"> <div className="process__bar"></div> </div>
                                <div className="text"> You Must Write Strong Password For Security, PLZ! </div>
                            </div>
                        </div>
                        <InputField htmlFor="repeat__password" title="Repeat password*" type="password" placeholder="Repeat password" required={true}
                            id="repeat__password" className="repeat__password" />
                        <div>

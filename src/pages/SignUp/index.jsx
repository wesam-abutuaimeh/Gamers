...
function SignUp(props) {
    ...
    const isPasswordStrong =
        hasUppercase && hasLowercase && hasDigits && hasSpecialChars && passwordValue.length >= 8;
                ...
                <div className="registration__area">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <div className="text">
                                {isPasswordStrong ? "Password is : Strong" : "You Must Write a Strong Password For Security, Please!"}
                            </div>
                        </div>
